...
\begin{figure}[h!]
  \centering
  \includegraphics[trim=0.75in 0.45in 0.85in 0.45in, clip, scale = 0.75]{{{plots/kh_t2.0_p2_low_res_collage}}}
...
The problem is established for two
...
\begin{figure}[h!]
  \centering
  \includegraphics[trim=0.75in 0.45in 0.85in 0.45in, clip, scale = 0.75]{{{plots/kh_t2.0_p3_low_res_collage}}}
  ...
  \includegraphics[scale=0.8]{{{plots/center_tagging_m_P_0.64_m_S_0.64}}}
    \caption[Nickel production as a function of static central refinement]
          {$^{56}$Ni production as a function of the maximum refinement factor
           ...
           all zones near the center of the domain. Compare to \autoref{fig:dxnuc_nickel};
           there, refinement occurs only after a detonation has begun, while here,
           the central contact point is maximally refined before the contact occurs and
           a detonation is formed.
...
two compared to \citeauthor{kushnir:2013} and \citealt{raskin:2010}) for the initially low resolution
